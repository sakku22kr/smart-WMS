    ...
    <PageWrapper>
      <div className="page-container max-w-3xl">
        <div className="page-header">
          <div>
            <h1 className="page-title">New Inventory Transaction</h1>
            <p className="page-subtitle">Record a stock movement</p>
          </div>
        </div>
        ...
        {loadingMeta ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-end gap-3 mt-6">
              <Button variant="secondary" leftIcon={<MdArrowBack />} onClick={() => navigate('/inventory')} type="button" disabled={loading}>
                Cancel
              </Button>
